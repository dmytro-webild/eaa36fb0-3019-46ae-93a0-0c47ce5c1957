...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        {
          imageSrc: "http://img.b2bpic.net/free-photo/minimal-work-space-creative-flat-lay-photo-workspace-desk-with-sketchbook-mobile-phone-with-blank-screen-copy-space-white-background-top-view-flat-lay-photography_1253-1063.jpg",
          imageAlt: "Abstract Tech",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/green-apple-spiral-notepad-pen-eyeglasses-laptop-blue-background_23-2148178578.jpg",
          imageAlt: "Workspace",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/minimal-work-space-creative-flat-lay-photo-workspace-desk-with-sketchbook-wooden-pencil-copy-space-white-background-top-view-flat-lay-photography_1253-991.jpg",
          imageAlt: "Creative flat lay photo of workspace desk",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/futuristic-metaverse-podium-empty-room-product-display-presentation-abstract-technology-scifi-with-neon-light-3d-background_56104-2316.jpg",
          imageAlt: "Futuristic metaverse podium empty room",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/digital-dot-circle-technology-corporate-background_53876-97644.jpg",
          imageAlt: "Digital dot circle technology background",
        },
      ]}
      ...
      testimonials={[
        {
          id: "t1",
          title: "Exceptional",
          quote: "The most professional demo platform I have ever used. Seamless integration.",
          name: "Sarah Chen",
          role: "CTO",
        ...
        },
        {
          id: "t2",
          title: "Game Changer",
          quote: "Our conversion rates doubled after implementing these tools. Highly recommended.",
          name: "Mark Adams",
          role: "Founder",
        ...
        },
        {
          ...
          quote: "The security and stability are unmatched in the current market.",
        ...
        },
        {
          id: "t4",
          title: "Perfect fit",
          quote: "Fits our enterprise needs perfectly with intuitive management tools.",
          name: "David Kim",
          role: "VP Operations",
        ...
        },
        {
          ...
          quote: "The support team and the feature set are exactly what we needed to scale.",
          name: "Julia Smith",
          role: "Director",
